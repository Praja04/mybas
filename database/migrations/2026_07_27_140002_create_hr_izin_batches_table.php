...
class CreateHrIzinBatchesTable extends Migration
{
    public function up()
    {
        if (Schema::hasTable('hr_izin_batches')) {
            return;
        }

        Schema::create('hr_izin_batches', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('overlap_count')->default(0);
            $table->integer('deleted_overtime_count')->default(0);
            $table->integer('deleted_orphan_count')->default(0);
            ...
            $table->text('overlap_log')->nullable();
    ...
    {
        Schema::dropIfExists('hr_izin_batches');
    }
}
