...
class LokerControllerOld extends Controller
{
    public function index()
    {
        ...
        return view('loker.old-index', compact('pilih_loker', 'master_loker', 'karyawan_baru', 'cek_loker_kosong', 'ps1', 'ps2', 'pb1', 'pb2', 'ws1', 'ws2', 'wb1', 'wb2', 'master_user', 'karyawan_kabur', 'cek_loker_terisi', 'cek_loker_rusak'));
    }
    ...
    {
        return DB::table('loker_master_area')->select('kode_area', 'nama_area')->orderBy('kode_area')->get();
    }

    public function blok($kode_area)
    {
        return DB::table('loker_master_blok')->where('kode_area', $kode_area)->select('kode_blok')->orderBy('kode_blok')->get();
    }

    public function nomer($kode_area, $kode_blok)
    {
        return DB::table('loker_master_nomer')->where('kode_area', $kode_area)->where('kode_blok', $kode_blok)->select('no_loker')->orderBy('no_loker')->get();
    }
}
