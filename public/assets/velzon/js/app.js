...
(function () {
            ...
            Array.from(collapses).forEach(function (collapse) {
                ...
                collapse.addEventListener("show.bs.collapse", function (e) {
                    ...
                    if (closestCollapse) {
                        ...
                        Array.from(siblingCollapses).forEach(
                            function (siblingCollapse) {
                                var siblingCollapseInstance =
                                    bootstrap.Collapse.getInstance(
                                        siblingCollapse,
                                    );
                                if (
                                    siblingCollapseInstance === collapseInstance
                                ) {
                                    return;
                                }
                ...
                collapse.addEventListener("hide.bs.collapse", function (e) {
                    ...
                    Array.from(childCollapses).forEach(
                        function (childCollapse) {
    ...
    function initActiveMenu() {
        ...
        currentPath =
            currentPath == "/"
                ? "/"
                : currentPath.substring(currentPath.lastIndexOf("/") + 1);
        // console.log('currentPath', currentPath, location.pathname)
        if (currentPath) {
            // navbar-nav
            var a = document
                .getElementById("navbar-nav")
                .querySelector('[data-identity="' + currentPath + '"]');
            if (a) {
                a.classList.add("active");
                var parentCollapseDiv = a.closest(".collapse.menu-dropdown");
                if (parentCollapseDiv) {
    ...
    function initModeSetting() {
        ...
        var currentMode = localStorage.getItem("data_layout_mode");
        if (currentMode) {
            if (currentMode == "dark") {
                setLayoutMode(
                    "data-layout-mode",
