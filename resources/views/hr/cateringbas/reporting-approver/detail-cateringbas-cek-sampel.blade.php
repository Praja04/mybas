                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($MenuMakanan as $kategoriStaff => $menusGrouped)
                                @php
                                    $totalUtama = count($menusGrouped['utama']);
                                    $totalPendamping = count($menusGrouped['pendamping']);
                                    $firstRow = true;
                                @endphp
                                @foreach ($menusGrouped['utama'] as $indexUtama => $itemUtama)
                                    <tr>
                                        @if ($firstRow)
                                    ...
                                    @endphp
                                @endforeach
                                @foreach ($menusGrouped['pendamping'] as $indexPendamping => $itemPendamping)
                                    <tr>
                                        @if ($indexPendamping == 0)
