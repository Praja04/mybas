                ...
                <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body">
                        <form action={{ url('/reporting/get-tanggal-pesanan') }} method="GET">
                            <div class="row">
                                ...
                                <div class="pl-4 d-flex justify-content-end">
                                    <div class="form-group">
                                        <?php if ($data->approval_cek_pesanan_at && $data->approval_cek_pesanan_by): ?>
                                        <a id="dataApprovePesanan" class="btn btn-success btn-lg">
                                            <div class="p-2">
                                        ...
                                        <?php else: ?>
                                        <a id="dataApprovePesanan" class="btn btn-success btn-lg" style="display: block;">
                                            <div class="p-2">
                                                <i class="fas fa-calendar-alt"></i>
                                                <span>data pesanan belum di approve</span>
                                            </div>
                                        </a>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="button-group pt-4" style="display: flex; gap: 20px;">
                            <a href="/cateringbas/reporting-GA-detail" id="kembalikehome" class="btn btn-danger">
