                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Data <span style="color: red">Pengambilan Sampel</span>
                                <span class="d-block text-muted pt-2 font-size-sm">Atur Data Sampel Catering</span>
                            </h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="pengirimCatering" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-1">Status Pengambilan Sampel</th>
                                    <th width="4%"><i class="fa fa-tools text-dark-75"></i></th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        $(document).ready(function() {
            var table = $('#pengirimCatering').DataTable({
                ...
                columns: [{
                    ...
                    // },
                    {
                        data: 'status_pengambilan_sampel',
                        render: function(data, type, row) {
                            if (data === 'belum') {
                                return '<span class="badge badge-danger">Belum</span>';
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (row.status_pengambilan_sampel === 'sudah') {
                                return `
                                <div class="mt-4">
                                    <a href="{{ url('/sample/') }}/${row.id_transaksi}"
