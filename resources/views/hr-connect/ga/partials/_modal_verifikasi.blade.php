@push('styles')
    <style>
        /* ========================================================
                                                       TUNE-UP UI MODAL VERIFIKASI (Presisi & Anti-Kepotong)
                                                       ======================================================== */
        #modalVerifikasi .modal-content {
            border-radius: 20px;
            /* HAPUS overflow:hidden biar bayangan & animasi ga kepotong */
        ...
        #modalVerifikasi .modal-footer {
            ...
            /* Warna abu-abu lembut biar beda sama body */
        }

        /* Area Scanner Presisi */
        .input-group-text {
            padding: 1rem;
        }
        ...
        /* Responsive Fix biar ga kepotong di layar kecil */
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-header bg-white border-0 pt-6 px-8 pb-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="mt-2">
                        <h4 class="font-weight-bolder text-dark mb-1">Otorisasi Penempatan Loker</h4>
                        <p class="text-muted font-weight-bold mb-0" style="font-size: 0.9rem;">
                            Tahap akhir: Pindai (tap) kartu identitas untuk memvalidasi data.
                        </p>
                    </div>
                </div>
                ...
                <div class="row justify-content-center" id="verif_scan_area">
                    <div class="col-md-11 text-center">
                        <div class="verif-scanner-box mx-auto">
                            <label class="font-weight-bolder text-info mb-3 d-block" style="letter-spacing: 1px;">AREA
                                PEMINDAIAN RFID</label>
                            ...
                            <div class="input-group input-group-lg mx-auto" style="max-width: 85%;">
                                ...
                                <input type="text" id="verif_rfid_scan"
                                    ...
                                    placeholder="Tap kartu ke scanner..." autocomplete="off" autofocus>
                            </div>
                    ...
                    <div class="verif-preview-card">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8 border-right pr-md-6">
                                <h6 class="font-weight-bolder text-dark border-bottom pb-3 mb-4">Detail Pemegang Kartu
                                </h6>
                                ...
                                <div class="row mb-5">
                                    <div class="col-12">
                                        <span class="text-muted font-weight-bold d-block mb-1"
                                            style="font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px;">Nama
                                            Lengkap</span>
                                ...
                                <div class="bg-light-info rounded p-3 border border-info border-left-info"
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <input type="text" id="verif_loker_tujuan"
                                            class="form-control-plaintext font-weight-bolder text-info p-0" readonly
                            ...
                            <div
                                class="col-md-4 text-center d-flex flex-column justify-content-center align-items-center pt-4 pt-md-0">
                                <span class="text-muted font-weight-bold mb-3"
                                    style="font-size: 0.75rem; text-transform: uppercase; letter-spacing: 1px;">Preview
                                    Foto Karyawan</span>
            ...
            <div class="modal-footer border-0 py-4 px-8 justify-content-between w-100" id="verif_footer"
                ...
                <button type="button" id="btnSimpanVerifikasi"
                    class="btn btn-info font-weight-bolder px-8 shadow-sm" disabled>
