        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Report Karyawan Masuk</h5>
                </div>
                <div class="card-body">
                    <div class="row mb-2">
                        <h5>Filter Data</h5>
...
let table = $("#tableAjax").dataTable({
    ...
    ajax: {
        type: "GET",
        url: "/hr-connect/report/getDataKaryawanMasuk"
    },
    columns: [
        { data: 'nama' },
        { data: 'nik' },
        ...
        { 
            ...
            render: function(data, type, row){
                let entryDate = new Date(row.tanggal_masuk);

                let tgl_masuk = entryDate.toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' });
