                                                                    ...
                                                                    <tr class="pas-background-color">
                                                                        ...
                                                                        <th class="text-white">
                                                                            <strong>
                                                                                ...
                                                                                @php
                                                                                    $totalNilai += $group->totalNilai/($group->persentase/100);
                                                                                @endphp
                                                                                @endforeach
            
                                                                                @if($periode->group->where('totalNilai', '!=', '0')->count() == 0) 0 @else {{ round($totalNilai / $periode->group->where('totalNilai', '!=', '0')->count(), 2) }} @endif --}}
                                                                            </strong>
                                                                        </th>
                                                                    </tr>
                                                                </thead>
