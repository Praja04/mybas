...
<body>
    ...
    <table style="width:100%; margin-top: 10px;">
        ...
        <tbody>
            <tr>
                <td style="font-weight: bold; text-align: center; color: #6B6A6B;">Data berita acara s.o.p supir yang
                    dihapus atas nama supir :</td>
            ...
            <tr>
                <td style="font-weight: bold; text-align: center; color: #6B6A6B;">Untuk melihat data berita acara s.o.p
                    supir yang dihapus silahkan masuk melalui link berikut ini:</td>
                <td style="font-weight: bold; text-align: center; color: black;"><a
                        href="{{ route('listsupir.trash') }}" style="text-decoration: none; color:red;">Menu Recycling
                        BA S.O.P Supir</a></td>
            </tr>
        </tbody>
