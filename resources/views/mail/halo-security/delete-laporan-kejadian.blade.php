...
<head>
    ...
    <title>(Halo Security) Terdapat Data Dihapus - Berita Acara Laporan Kejadian</title>
    <style>
        table,
        th,
        td {
...
<body>
    ...
    <h2 style="text-align: center; color: #6A6A6A;">
        <span style="color: red; font-weight: bold;">Data Dihapus</span> - (Halo
        Security) Berita Acara Laporan Kejadian
    </h2>

    <p style="text-align: center; color: #6B6A6B;">Terdapat data berita acara laporan kejadian yang dihapus, silahkan
        hubungi
        ke security POS 1.</p>
    ...
    <table style="width:100%; margin-top: 10px;">
        ...
        <tbody>
            <tr>
                <td style="font-weight: bold; text-align: center; color: #6B6A6B;">Data berita acara laporan kejadian
                    yang dihapus atas nama korban :</td>
            ...
            <tr>
                <td style="font-weight: bold; text-align: center; color: #6B6A6B;">Untuk melihat data berita acara
                    laporan kejadian yang dihapus silahkan masuk melalui link berikut ini:</td>
                <td style="font-weight: bold; text-align: center; color: black;"><a
                        href="{{ route('listlaporankejadian.trash') }}" style="text-decoration: none; color:red;">Menu
                        Recycling BA Laporan Kejadian</a></td>
            </tr>
        </tbody>
