...
<head>
    ...
    <title>Pengingat Sertifikasi Legalitas - SIGRA Notification</title>
</head>
...
<body
    ...
    <div
        ...
        <h2 style="text-align: center; color: #a80000; margin-bottom: 10px;">
            SIGRA - Pengingat Sertifikasi Legalitas
        </h2>

        <p style="text-align: center; font-size: 13px; color: #6c757d; margin-top: 0;">
            MyBAS mendeteksi adanya Sertifikasi Legalitas yang akan atau telah melewati masa berlaku.
        </p>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
            <thead>
                <tr style="background-color: #a80000; color: #fff;">
                    ...
                    <th style="border: 1px solid #ddd; padding: 8px;">Nama Dokumen</th>
                    <th style="border: 1px solid #ddd; padding: 8px;">Nomor Dokumen</th>
                    <th style="border: 1px solid #ddd; padding: 8px;">Instansi</th>
            ...
            <tbody>
                @foreach ($sertifikasi as $key => $sertifikat)
                    <tr style="background-color: {{ $sertifikat->due_date > 0 ? '#FFF8E1' : '#FDECEA' }};">
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px;">{{ $sertifikat->nama_legalitas }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px;">{{ $sertifikat->nomor_dokumen }}</td>
                        <td style="border: 1px solid #ddd; padding: 8px;">{{ $sertifikat->instansi }}</td>
