        ...
        <div class="card shadow-none border-0" style="margin-top: 12px">
            <div class="card-body border-0">
                ...
                <div style="margin-left: 5px;">
                    <p style="font-size: 13px;">Nama<span style="margin-left: 85px;">: {{ $item->nama_pelaku }}</span>
                    </p>
                    <p style="font-size: 13px;">No KTP<span style="margin-left: 74px;">:
                            {{ $item->nik_ktp_pelaku }}</span></p>
                    <p style="font-size: 13px;">NIK<span style="margin-left: 98px;">: {{ $item->nik_pelaku }}</span></p>
                    <p style="font-size: 13px;">Pekerjaan<span style="margin-left: 61px;">:
                            {{ $item->pekerjaan_pelaku }}</span></p>
                    <p style="font-size: 13px;">Jabatan/Bagian<span style="margin-left: 30px;">:
                            {{ $item->bagian_pelaku }}</span></p>
                    <p style="font-size: 13px;">No.Handphone<span style="margin-left: 33px;">:
                            {{ $item->no_hp_pelaku }}</span></p>
                    ...
                    <p style="font-size: 13px; margin-top: 20px; text-align: justify;"><span
