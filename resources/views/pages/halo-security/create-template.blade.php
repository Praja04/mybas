...
<div class="container-fluid">
    <div class="card">
        <div class="card-header align-items-center d-flex">
            <h4 class="card-title mb-0 flex-grow-1">Buat Template Tanya Jawab Introgasi</h4>
        </div>

        <div class="card-body">
            <form action="{{ route('store-template') }}" method="POST" autocomplete="off">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label for="pertanyaan_introgasi" class="form-label">Pertanyaan Introgasi</label>
                            <textarea class="form-control" name="pertanyaan_introgasi" id="pertanyaan_introgasi-textarea" value="{{old('pertanyaan_introgasi')}}" rows="3"></textarea>
                            {{-- <div id="pertanyaan_introgasi"></div> --}}
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="jawaban_introgasi" id="jawaban_introgasi-textarea" value="{{old('jawaban_introgasi')}}" rows="3"></textarea>
                            {{-- <div id="jawaban_introgasi"></div> --}}
                            <p class="text-danger ml-2">
