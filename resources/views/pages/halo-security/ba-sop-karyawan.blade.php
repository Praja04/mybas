...
<html lang="en">
	<head>
        <base href="{{ url('/') }}">
		<title>Berita Acara S.O.P Karyawan</title>
		<meta charset="utf-8" />
                ...
                <div class="card-body border-0">
                            ...
                            <tr>
                                ...
                                <td style="border: 1px solid; padding: 5px 10px 5px 5px; text-align: center; vertical-align: middle; width: 80%;">
                                    <div style="padding-top: 20px; padding-bottom: 20px;">
                                        <h1 style="font-size: 18px; margin: 0;">FORM BERITA ACARA SOP</h1>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <div style="border: 1px solid; padding: 10px; margin-top:10px;">
                                ...
                                <tbody>
                                    <tr style="height: 22.2px; text-align: center;">
                                        <td style="width: 258px; height: 22.2px;" colspan="2">
                                            <span style="text-decoration: underline; font-weight:bold;">BERITA ACARA SOP</span>
                                        </td>
                                    </tr>
                                    <tr style="height: 22px;">
                                        <td style="width: 101.738px; height: 22px; text-align: center;">No.</td>
                                        <td style="width: 154.262px; height: 22px;">&nbsp;</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div style="margin-left: 5px;">
                            ...
                            <p style="font-size: 13px; margin-top: 20px;">Berdasarkan pelanggaran.</p>
                            <p style="font-size: 13px;">Nama<span style="margin-left: 85px;">: {{ $item->nama }}</span></p>
                            <p style="font-size: 13px;">Nik<span style="margin-left: 102px;">: {{ $item->nik }}</span></p>
                            <p style="font-size: 13px;">Jabatan / Bagian<span style="margin-left: 23px;">: {{ $item->jabatan }}</span></p>
                            <p style="font-size: 13px;">Jenis Kelamin<span style="margin-left: 40px;">: {{ $item->jenis_kelamin }}</span></p>
    
                            <p style="font-size: 13px; margin-top: 45px;">Pada saat memasuki area <u>{{ $item->nama_area }}</u> saudara / saudari : <u>{{ $item->nama }}</u></p>
                            <p style="font-size: 13px; text-align: justify;">Membawa <u>{{ $item->barang }}</u> dan saudara / saudari : <u>{{ $item->nama }}</u> diarahkan ke pos 1 ( pos utama security ) untuk ditindak lanjut atau diproses sesuai S.O.P PT Bumi Alam Segar pada saat diproses saudara / saudari : <u>{{ $item->nama }}</u> mengakui kesalahannya dan siap menerima sanksi dari perusahaan sesuai yang ada di peraturan perusahaan PT Bumi Alam Segar</p>
                            <p style="font-size: 13px; text-align: justify;"><span style="margin-left: 15px;">Demikian</span> berita acara ini saya buat dengan sebenar-benarnya dan dapat dipertanggung jawabkan kepada pimpinan PT Bumi Alam Segar.</p>
