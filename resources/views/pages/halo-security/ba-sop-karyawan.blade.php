                ...
                <div style="border: 1px solid; padding: 10px; margin-top:10px;">
                    ...
                    <div style="margin-left: 5px;">
                        <p style="font-size: 13px; margin-top: 30px; text-align: justify;">
                            ...
                            Jam : <u style="margin-right: 10px;">{{ date('H:i:s', strtotime($item->created_at)) }}
                                WIB</u>
                        ...
                        <p style="font-size: 13px;">Nama<span style="margin-left: 85px;">: {{ $item->nama }}</span>
                        </p>
                        <p style="font-size: 13px;">Nik<span style="margin-left: 102px;">: {{ $item->nik }}</span>
                        </p>
                        <p style="font-size: 13px;">Jabatan / Bagian<span style="margin-left: 23px;">:
                                {{ $item->jabatan }}</span></p>
                        <p style="font-size: 13px;">Jenis Kelamin<span style="margin-left: 40px;">:
                                {{ $item->jenis_kelamin }}</span></p>

                        <p style="font-size: 13px; margin-top: 45px;">Pada saat memasuki area
                            <u>{{ $item->nama_area }}</u> saudara / saudari : <u>{{ $item->nama }}</u>
                        </p>
                        <p style="font-size: 13px; text-align: justify;">Melakukan jenis pelanggaran berupa
                            <u>{{ $item->barang }}</u> dan saudara
                            / saudari : <u>{{ $item->nama }}</u> diarahkan ke pos 1 ( pos utama security ) untuk
                            ditindak lanjut atau diproses sesuai S.O.P PT Bumi Alam Segar pada saat diproses saudara /
                            saudari : <u>{{ $item->nama }}</u> mengakui kesalahannya dan siap menerima sanksi dari
                            perusahaan sesuai yang ada di peraturan perusahaan PT Bumi Alam Segar
                        </p>
                        <p style="font-size: 13px; text-align: justify;"><span
