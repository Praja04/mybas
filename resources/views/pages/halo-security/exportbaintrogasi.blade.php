...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="32" style="text-align: center">PT. BUMI ALAM SEGAR</th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th scope="col" class="text-center" style="text-align: center;">NIK (Nomor Induk Karyawan) Korban
                </th>
                ...
                <th scope="col" class="text-center" style="text-align: center;">NIK (Nomor Induk Karyawan) Pelaku
                </th>
                ...
                @for ($i = 0; $i < collect(count($item->baiitems))->max(); $i++)
                    <tr>
                        ...
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->jenis_kejadian }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->nama_introgasi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->umur_introgasi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->pekerjaan_introgasi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->bagian_introgasi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->nama_pelapor }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->detail_barang_kejadian }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->tempat_kejadian }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->nama_korban }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->nik_korban }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->bagian_korban }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->nama_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->umur_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->ttl_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->pekerjaan_pelaku }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->nik_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->bagian_pelaku }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->alamat_pelaku }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->agama_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->suku_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                        ...
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->pendidikan_pelaku }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->nik_ktp_pelaku }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->no_hp_pelaku }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->tempat_introgasi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->keterangan_kejadian }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                        ...
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->created_at }}
                        </td>
                    </tr>
                @endfor
            @endforeach
