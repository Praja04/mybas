...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="35" style="text-align: center">PT. BUMI ALAM SEGAR</th>
            </tr>
            <tr>
            ...
            @foreach ($balaporankejadian as $key => $item)
                @for ($i = 0; $i < collect([count($item->faktas), count($item->saksis)])->max(); $i++)
                    <tr>
                        ...
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->perusahaan_korban }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->bagian_korban }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->lokasi_kejadian }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            @if (isset($item->faktas[$i]))
                                {{ $item->faktas[$i]->lk_id }} - {{ $item->faktas[$i]->keterangan_fakta }}
                            @endif
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->yang_terjadi }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->nama_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->umur_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">{{ $item->ttl_terlapor }}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->pekerjaan_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->alamat_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->kelurahan_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->kecamatan_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->provinsi_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->status_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->agama_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->kebangsaan_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->no_ktp_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->no_simc_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->no_hp_terlapor }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->bagaimana_terjadi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                            {{ $item->mengapa_terjadi }}</td>
                        <td scope="row" class="text-center" style="text-align: center;">
                        ...
                        <td scope="row" class="text-center" style="text-align: center;">{!! $item->uraian_kejadian !!}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{!! $item->tindakan_pengamanan !!}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{!! $item->hasil_daritindakan !!}
                        </td>
                        <td scope="row" class="text-center" style="text-align: center;">{!! $item->saran !!}
                        </td>
