        ...
        <div class="card shadow-none border-0">
            <div class="card-body border-0">
                @if ($item->faktas->count() == 1)
                    ...
                    <table class="table table-bordered" style="width: 100%;">
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="3" colspan="4" style="text-align: center">
                                    <img style="height:auto; width:auto; max-width:60%;"
                                        src="data:image/png;base64,{{ base64_encode(file_get_contents('./assets/media/logos/delta_guard_hd.png')) }}"
                                        alt="delta guard">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="11"
                                    style="font-weight: bold; border-color: black; background-color: rgb(52, 52, 207);">
                                    <p style="margin-top: -2px; margin-bottom: -2px;">JENIS KEJADIAN</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="11" style="text-align: center">
                                    @if ($item->jenis_kejadian == 'kecelakaan lalu lintas')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Kecelakaan
                                            Lalu Lintas</p>
                                    @elseif($item->jenis_kejadian == 'penemuan barang')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Penemuan
                                            Barang</p>
                                    ...
                                    @elseif($item->jenis_kejadian == 'perkelahian')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Perkelahian
                                        </p>
                                    @elseif($item->jenis_kejadian == 'tindak kekerasan')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Tindak
                                            Kekerasan</p>
                                    ...
                                    @elseif($item->jenis_kejadian == 'demonstrasi')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Demonstrasi
                                        </p>
                                    @elseif($item->jenis_kejadian == 'tindakan asusila')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Tindakan
                                            Asusila</p>
                                    @elseif($item->jenis_kejadian == 'pengerusakan')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Pengerusakan
                                        </p>
                                    @elseif($item->jenis_kejadian == 'tindakan indispliner')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Tindakan
                                            Indispliner</p>
                                    @else
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">
                                            {{ $item->jenis_kejadian }}</p>
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="11"
                                    style="font-weight: bold; border-color: black; background-color: rgb(52, 52, 207);">
                                    <p style="margin: 2px;">LAPORAN AWAL</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p
                                        style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">
                                        a.</p>
                                </td>
                                <td colspan="4">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Dari (Nama) : Sdr.
                                        {{ $item->nama_korban }}</p>
                                </td>
                                <td>
                                    <p
                                ...
                                <td colspan="5">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Tanggal Laporan :
                                        {{ explode('-', formatTanggalIndonesia2($item->created_at))[0] }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="4">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Nik :
                                        {{ $item->nik_korban }}</p>
                                </td>
                                <td>
                                    <p
                                ...
                                <td colspan="5">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Waktu Laporan :
                                        {{ date('H.i', strtotime($item->created_at)) }} wib</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="4">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Perusahaan :
                                        {{ $item->perusahaan_korban }}</p>
                                </td>
                                <td>
                                    <p
                                        style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">
                                ...
                                <td colspan="5">
                                    <p
                                        style="margin-top: 2px; margin-bottom: 2px; margin-left: -2px; margin-right: -2px; font-size: 13px;">
                                        Bagian : {{ $item->bagian_korban }}</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="11"
                                    style="font-weight: bold; border-color: black; background-color: rgb(52, 52, 207);">
                                    <p style="margin: 2px;">PENJELASAN KEJADIAN</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="4">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Tanggal Kejadian :
                                        {{ explode('-', formatTanggalIndonesia2($item->created_at))[0] }}</p>
                                </td>
                                <td>
                                    <p
                                ...
                                <td colspan="5">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Waktu Kejadian :
                                        {{ date('H.i', strtotime($item->created_at)) }} wib</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="10">
                                    <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Lokasi Kejadian :
                            ...
                            <tr>
                                ...
                                <td colspan="11" style="font-weight: bold; background-color: rgb(52, 52, 207);">
                                    <p style="margin: 2px;">FAKTA - FAKTA KEJADIAN</p>
                                </td>
                            </tr>
                            @foreach ($item->faktas as $result)
                                <tr>
                                    <td colspan="11">
                                        <p>{{ $loop->iteration }}. <span
                                                style="margin-left: 10px; text-align: justify;">{{ $result->keterangan_fakta }}</span>
                                        </p>
                                    </td>
                                </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td colspan="11"
                                    style="font-weight: bold; border-color: black; background-color: rgb(52, 52, 207);">
                                    <p style="margin-top: 10px; margin-bottom: 10px;">PERISTIWA YANG DILAPORKAN</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p
                                        style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">
                                        1.</p>
                                </td>
                                <td colspan="3">
                                ...
                                <td colspan="7">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> : Sekira pukul
                                        {{ date('H.i', strtotime($item->created_at)) }} wib</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Tempat Kejadian
                                    </p>
                                </td>
                                <td colspan="7">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Apa yang terjadi
                                    </p>
                                </td>
                                <td colspan="7">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> :
                            ...
                            <tr>
                                ...
                                <td colspan="7">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> : Sdr.
                                        {{ $item->nama_terlapor }}, Umur : {{ $item->umur_terlapor }}, Tempat Tanggal
                                        Lahir : {{ $item->ttl_terlapor }}, Pekerjaan :
                                        {{ $item->pekerjaan_terlapor }}, Alamat : {{ $item->alamat_terlapor }},
                                        Kelurahan : {{ $item->kelurahan_terlapor }}, Kecamatan :
                                        {{ $item->kecamatan_terlapor }}, Provinsi : {{ $item->provinsi_terlapor }},
                                        Status : {{ $item->status_terlapor }}, Agama : {{ $item->agama_terlapor }},
                                        Kebangsaan : {{ $item->kebangsaan_terlapor }}, No. KTP :
                                        {{ $item->no_ktp_terlapor }}, No. SIM (C) : {{ $item->no_simc_terlapor }}, No.
                                        HP : {{ $item->no_hp_terlapor }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Bagaimana Terjadi
                                    </p>
                                </td>
                                <td colspan="7">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> :
                                        {{ $item->bagaimana_terjadi }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="3">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Mengapa Terjadi
                                    </p>
                                </td>
                                <td colspan="7">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> :
                                        {{ $item->mengapa_terjadi }}</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td colspan="3">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Dilaporkan Pada
                                    </p>
                                </td>
                                <td colspan="7">
                                    <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> : Pada hari
                                        {{ formatHariIndonesia($item->created_at) }}
                                        {{ explode('-', formatTanggalIndonesia2($item->created_at))[0] }}</p>
                                </td>
                            </tr>
                    ...
                    <table class="table table-bordered" style="width: 100%;">
                        <tbody>
                            <tr>
                                <td rowspan="{{ $item->saksis->count() + 2 }}"
                                    style="text-align: center; font-weight: bold;">
                                    <p>6.</p>
                                </td>
                                <td colspan="14"
                                    style="text-align: center; font-weight: bold; border-color: black; background-color: rgb(52, 52, 207);">
                                    <p style="margin-top: 10px; margin-bottom: 10px;">SAKSI - SAKSI</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p
                                        style="margin-top: 5px; margin-bottom: 5px; text-align: center; font-size: 13px; padding-right: 8px; padding-left: 6px;">
                                        No.</p>
                                </td>
                                <td colspan="3">
                                    <p
                            ...
                            @foreach ($item->saksis as $result)
                                <tr>
                                    <td>
                                        <p
                                            style="margin-top: 5px; text-align: center; margin-bottom: 5px; font-size: 13px; padding-right: 8px; padding-left: 6px;">
                                            {{ $loop->iteration }}.</p>
                                    </td>
                                    <td colspan="3">
                                        <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">
                                    ...
                                    <td colspan="2">
                                        <p
                                            style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">
                                            {{ $result->departement_saksi }}</p>
                                    </td>
                                    <td colspan="6">
                                        <p
                                            style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">
                                            {{ $result->keterangan_saksi }}</p>
                                    </td>
                                </tr>
                            @endforeach
                            <tr>
                                ...
                                <td colspan="14"
                                    style="font-weight: bold; border-color: black; background-color: rgb(52, 52, 207); color: white;">
                            ...
                            <tr>
                                ...
                                <td colspan="14" style="font-weight: bold;">
                                    <p style="margin-top: 10px; margin-bottom: 10px;">URAIAN KEJADIAN</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="14" style="font-weight: bold;">
                                    <p style="margin-top: 10px; margin-bottom: 10px;">TINDAKAN PENGAMANAN</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="14" style="text-align: justify;">
                    ...
                    <table class="table table-bordered" style="width: 100%;">
                        <tbody>
                            <tr>
                                <td rowspan="2" style="text-align: center; font-weight: bold;">
                                    <p style="padding-left: 25px; padding-right: 19px;">10.</p>
                                </td>
                                <td colspan="8" style="font-weight: bold;">
                                    <p style="margin-top: 10px; margin-bottom: 10px;">HASIL DARI TINDAKAN</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="8">
                            ...
                            <tr>
                                <td rowspan="2" style="text-align: center; font-weight: bold;">
                                    <p style="padding-left: 28px; padding-right: 21px;">11.</p>
                                </td>
                                <td colspan="8" style="font-weight: bold;">
                                    <p style="margin-top: 10px; margin-bottom: 10px;">SARAN</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="8">
                            ...
                            <tr>
                                <td rowspan="4" style="text-align: center; font-weight: bold;">
                                    <p style="padding-left: 20px; padding-right: 13px;">12.</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="font-weight: bold; text-align: center;">Nancy Krisnawati
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2" style="text-align: center">HR & GA PT BAS</td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="page_break">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="4" style="text-align: center; font-weight: bold;">
                                        <p style="padding-right: 2px; padding-left: 5px;">KETERANGAN</p>
                                    </td>
                                </tr>
                                        ...
                                        <td colspan="6">
                                            ...
                                            <div
                                                ...
                                                @foreach (explode(',', $result->foto_kejadian) as $image)
                                                    <img src="data:image/jpg;base64,{{ base64_encode(file_get_contents('./master_laporan_kejadian_gambar/' . $image)) }}"
                                                        style="width: 150px; height: 150px; margin-right: 10px;">
                                                @endforeach
                                            </div>
                                        </td>
                                        <td colspan="4" style="text-align:center; vertical-align: top;">
                                            <p style="font-size: 13px; margin-left: 10px; text-align: justify;">
                                                {{ $result->keterangan_kejadian }}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div
                            style="margin-left: 5px; margin-top: 10px; margin-bottom: 10px; border-bottom: 1px solid #000; width: 98.5%">
                        </div>
                        <p style="margin: 0; margin-left: 5px; font-weight: bold; line-height: 10px; font-size: 12px">
                            FRM-GAP-002-017 <br />Rev.01 - 23 Maret 2023</p>
                    </div>
                @elseif(
                    ($item->faktas->count() == 7 && $item->saksis->count() == 1) ||
                        ($item->faktas->count() == 7 && $item->saksis->count() > 1))
                    @php
                        $rowCounter = 0;
                    @endphp
                    <table class="table table-bordered" style="width: 100%;">
                        <tbody>
                            <tr>
                                <td rowspan="3" colspan="5" style="text-align: center">
                                    <img style="width: 180px; height: 80px"
                                        src="data:image/png;base64,{{ base64_encode(file_get_contents('./assets/media/logos/bas_text.png')) }}"
                                        alt="Kop Surat">
                                </td>
                                ...
                                <td rowspan="3" colspan="5" style="text-align: center">
                                    <img style="width: 120px; height: 75px;"
                                        src="data:image/png;base64,{{ base64_encode(file_get_contents('./assets/media/logos/delta guard.jpg')) }}"
                                        alt="delta guard">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="14" style="text-align: center">
                                    ...
                                    @elseif($item->jenis_kejadian == 'kecelakaan kerja')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Kecelakaan
                                            Kerja</p>
                                    @elseif($item->jenis_kejadian == 'pencurian')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Pencurian
                                        </p>
                                    @elseif($item->jenis_kejadian == 'perkelahian')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Perkelahian
                                        </p>
                                    @elseif($item->jenis_kejadian == 'tindak kekerasan')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Tindak
                                            Kekerasan</p>
                                    @elseif($item->jenis_kejadian == 'kebakaran')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Kebakaran
                                        </p>
                                    @elseif($item->jenis_kejadian == 'demonstrasi')
                                        <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Demonstrasi
                                        </p>
                            ...
                            <tr>
                                ...
                                <td colspan="14" style="font-weight: bold; background-color: rgb(52, 52, 207);">
                                    <p style="margin: 2px;">FAKTA - FAKTA KEJADIAN</p>
                                </td>
                            </tr>
                            @foreach ($item->faktas as $result)
                ...
                <tr>
                    <td @if (strlen($result->keterangan_fakta) > 4) colspan="14" @else colspan="10" @endif>
                        <p style="text-align: justify;">{{ $loop->iteration }}. <span
                                style="margin-left: 10px;">{{ $result->keterangan_fakta }}</span></p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="10">
                        <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: justify;"> :
                            {{ $item->yang_terjadi }}</p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="10">
                        <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: justify;"> : Sdr.
                            {{ $item->nama_terlapor }}, Umur : {{ $item->umur_terlapor }}, Tempat Tanggal Lahir :
                            {{ $item->ttl_terlapor }}, Pekerjaan : {{ $item->pekerjaan_terlapor }}, Alamat :
                            {{ $item->alamat_terlapor }}, Kelurahan : {{ $item->kelurahan_terlapor }}, Kecamatan :
                            {{ $item->kecamatan_terlapor }}, Provinsi : {{ $item->provinsi_terlapor }}, Status :
                            {{ $item->status_terlapor }}, Agama : {{ $item->agama_terlapor }}, Kebangsaan :
                            {{ $item->kebangsaan_terlapor }}, No. KTP : {{ $item->no_ktp_terlapor }}, No. SIM (C) :
                            {{ $item->no_simc_terlapor }}, No. HP : {{ $item->no_hp_terlapor }}</p>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <table class="table table-bordered" style="width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">
                                    Nama</p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">1.
                                </p>
                            </td>
                            <td colspan="15">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">
            ...
            @else
                ...
                <table class="table table-bordered" style="width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="11" style="text-align: center">
                                @if ($item->jenis_kejadian == 'kecelakaan lalu lintas')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Kecelakaan Lalu
                                        Lintas</p>
                                @elseif($item->jenis_kejadian == 'penemuan barang')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Penemuan Barang
                                    </p>
                                @elseif($item->jenis_kejadian == 'kecelakaan kerja')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Kecelakaan Kerja
                                    </p>
                                @elseif($item->jenis_kejadian == 'pencurian')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Pencurian</p>
                                @elseif($item->jenis_kejadian == 'perkelahian')
                                ...
                                @elseif($item->jenis_kejadian == 'tindak kekerasan')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Tindak Kekerasan
                                    </p>
                                @elseif($item->jenis_kejadian == 'kebakaran')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Kebakaran</p>
                                @elseif($item->jenis_kejadian == 'demonstrasi')
                                ...
                                @elseif($item->jenis_kejadian == 'tindakan asusila')
                                    <p style="margin-top: -2px; margin-bottom: -2px; font-size: 13px;">Tindakan Asusila
                                    </p>
                                @elseif($item->jenis_kejadian == 'pengerusakan')
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">a.
                                </p>
                            </td>
                            <td colspan="4">
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Dari (Nama) : Sdr.
                            ...
                            <td>
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">d.
                                </p>
                            </td>
                            <td colspan="5">
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Tanggal Laporan :
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">b.
                                </p>
                            </td>
                            <td colspan="4">
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Nik :
                            ...
                            <td>
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">e.
                                </p>
                            </td>
                            <td colspan="5">
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Waktu Laporan :
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">c.
                                </p>
                            </td>
                            <td colspan="4">
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px;">Perusahaan :
                            ...
                            <td>
                                <p style="margin-top: 2px; margin-bottom: 2px; font-size: 13px; text-align: center;">f.
                                </p>
                            </td>
                            <td colspan="5">
                                <p
                ...
                <table class="table table-bordered" style="width: 100%;">
                    <tbody>
                        <tr>
                            <td rowspan="{{ $item->faktas->filter(function ($result) {return strlen($result->keterangan_fakta) > 3;})->count() - 2 }}"
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">2.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Tempat Kejadian</p>
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">3.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Apa yang terjadi</p>
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">4.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Siapa Terlapor</p>
                            ...
                            <td colspan="7">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;"> : Sdr.
                                    {{ $item->nama_terlapor }}, Umur : {{ $item->umur_terlapor }}, Tempat Tanggal
                                    Lahir : {{ $item->ttl_terlapor }}, Pekerjaan : {{ $item->pekerjaan_terlapor }},
                                    Alamat : {{ $item->alamat_terlapor }}, Kelurahan :
                                    {{ $item->kelurahan_terlapor }}, Kecamatan : {{ $item->kecamatan_terlapor }},
                                    Provinsi : {{ $item->provinsi_terlapor }}, Status :
                                    {{ $item->status_terlapor }}, Agama : {{ $item->agama_terlapor }}, Kebangsaan :
                                    {{ $item->kebangsaan_terlapor }}, No. KTP : {{ $item->no_ktp_terlapor }}, No.
                                    SIM (C) : {{ $item->no_simc_terlapor }}, No. HP : {{ $item->no_hp_terlapor }}
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">5.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Korbannya</p>
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">6.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Bagaimana Terjadi</p>
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">7.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Mengapa Terjadi</p>
                        ...
                        <tr>
                            <td>
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px; text-align: center;">8.
                                </p>
                            </td>
                            <td colspan="3">
                                <p style="margin-top: 5px; margin-bottom: 5px; font-size: 13px;">Dilaporkan Pada</p>
                ...
                <table class="table table-bordered" style="width: 100%;">
                    <tbody>
                        ...
                        <tr>
                            <td rowspan="2" style="text-align: center; font-weight: bold;">
                                <p style="padding-left: 28px; padding-right: 28px;">8.</p>
                            </td>
                            <td colspan="8" style="font-weight: bold;">
                                <p style="margin-top: 10px; margin-bottom: 10px;">URAIAN KEJADIAN</p>
                            </td>
                        ...
                        <tr>
                            <td rowspan="2" style="text-align: center; font-weight: bold;">
                                <p style="padding-left: 20px; padding-right: 16px;">9.</p>
                            </td>
                            <td colspan="8" style="font-weight: bold;">
                                <p style="margin-top: 10px; margin-bottom: 10px;">TINDAKAN PENGAMANAN</p>
                            </td>
