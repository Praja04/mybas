        ...
        <div class="card shadow-none border-0" style="margin-top: 12px">
            <div class="card-body border-0">
                        ...
                        <tbody>
                            <tr style="height: 18px.2px; text-align: center;">
                                <td style="width: 258px; height: 18.2px;" colspan="2">
                                    <span style="text-decoration: underline; font-weight:bold;">BERITA ACARA
                                        INTROGASI</span>
                                </td>
                            </tr>
                ...
                <div style="margin-left: 5px;">
                    <p class="text-line center"><span>Pada hari ini {{ formatHariIndonesia($item->created_at) }} tanggal
                            : {{ explode('-', formatTanggalIndonesia2($item->created_at))[0] }} sekira pukul
                            {{ date('H:i', strtotime($item->created_at)) }} wib. oleh Saya :</span></p>
                    ...
                    ?>
                    <p
                        style="text-align: justify; font-size: 13px; margin-bottom: 30px; padding-right: 3px; overflow: hidden;">
                        {!! $identitas1 !!}</p>
                    ...
                    ?>
                    <p
                        style="text-align: justify; font-size: 13px; margin-top: 30px; padding-right: 3px; overflow: hidden;">
                        {!! $identitas2 !!}</p>
                    ...
                    ?>
                    <p style="text-align: justify; font-size: 13px; padding-right: 3px; overflow: hidden">
                        {!! $identitas3 !!}</p>
                    ...
                    <p style="font-size: 13px; margin-top: 20px; margin-bottom: 20px;"><span
                            style="margin-left: 40px;">Pertanyaan :</span><span style="margin-left: 450px;">Jawaban
                            :</span></p>
                    @foreach ($item->baiitems as $result)
                        @php
                            $pertanyaan =
                                "Ditanyakan kepada Sdr. <span class='bold-text2'>$item->nama_pelaku</span> " .
                                $result->pertanyaan_introgasi;
                            ...
                            $pertanyaan .=
                                ' <span style="white-space: nowrap; word-spacing: -4px">' . $spaces . '</span>';
                        @endphp
                        <p style="font-size: 13px;">{{ $loop->iteration }}.</p>
                        <p
                            style="margin-top: -30px; text-align: justify; margin-left: 20px; font-size: 13px; padding-right: 1px; overflow: hidden">
                            {!! $pertanyaan !!}</p>
                        @php
                        ...
                        <p
                            style="margin-top: -30px; text-align: justify; margin-left: 50px; font-size: 13px; padding-right: 1px; overflow: hidden">
                            {!! $jawaban !!}</p>
                        ...
                        <tbody>
                            <tr>
                                <td colspan="3">
                                    ...
                                    <p
                                        style="margin-left: 445px; margin-bottom: 40px; font-weight: bold; text-align: center;">
                                        <u>{{ $item->nama_pelaku }}</u>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center;" colspan="3">--------------- Demikian berita acara
                                    introgasi ini dibuat berdasarkan tugas dan tanggung jawab yang diterima saat ini,
                                    kemudian ditutup dam ditanda tangani pada, hari, tanggal, bulan dan tahun tersebut
                                    di atas. --------------------------------------</td>
                            </tr>
                            <tr>
                                <td colspan="3">
                            ...
                            <tr>
                                <td style="font-weight: bold;" colspan="3">
                                    <p style="margin-left: 500px;"><u>{{ $item->nama_introgasi }}</u></p>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;" colspan="3">
                                    <p style="margin-left: 505px; font-style: italic; margin-top: -10px;">
                                        {{ $item->bagian_introgasi }}</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td style="font-weight: bold; text-align: center;">( ___________________ )</td>
