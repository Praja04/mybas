...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="card card-custom bg-light-warning" style="border-radius: 26px;">
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <a href="#modal_loker_kosong" class="btn btn-success btn-sm ml-4 font-weight-bolder"
                                data-toggle="modal" aria-haspopup="true" aria-expanded="false"
                                style="border-radius: 26px;"><i class="fas fa-search"></i> Cek Stok Loker Kosong</a>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            @foreach ($pilih_loker as $loker)
                                <div class="col-sm-6">
                                    <div class="card card-custom card-stretch bg-light-warning gutter-b Card_Loker Card_{{ $loker->kode_area }}"
                                            ...
                                            <div class="card-toolbar">
                                                <div class="dropdown dropdown-inline">
                                                    <a href="#" onclick="return false;"
                                                        class="btn btn-primary btn-sm font-weight-bolder dropdown-toggle "
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                                        style="border-radius: 26px;"><i class="fas fa-tools"></i> Tools</a>
                                                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                        <ul class="navi navi-hover">
                                                            <li class="navi-header pb-1">
                                                                <span
                                                                    class="text-primary text-uppercase font-weight-bold font-size-sm">Tools:</span>
                                                            </li>
                                                            <li class="navi-item">
                                                                <a href="{{ url('loker/history_loker/' . $loker->kode_area) }}"
                                                                    class="navi-link">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="{{ url('loker/database/' . $loker->kode_area) }}"
                                                                    class="navi-link">
                                                                    <span class="navi-icon">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="javascript:void(0)"
                                                                    onclick="upload_excel('{{ $loker->kode_area }}')"
                                                                    class="navi-link">
                                                                    <span class="navi-icon">
                                                            ...
                                                            <li class="navi-item">
                                                                <a href="javascript:void(0)"
                                                                    onclick="export_excel('{{ $loker->kode_area }}')"
                                                                    class="navi-link">
                                                                    <span class="navi-icon">
                                                                        <i class="fas fa-file-excel text-dark"></i>
                                                                    </span>
                                        ...
                                        <div class="card-body d-flex align-items-center py-0 mt-8">
                                            <a href="#" onclick="return false;"
                                                class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary Click_area_card"
                                                data-kode-area="{{ $loker->kode_area }}">{{ $loker->nama_area }}</a>
                                            <div class="d-flex flex-column flex-grow-1 py-2 py-lg-5">
                                            </div>
                                            @if ($loker->kode_area == 'PB')
                                                <img src="assets/media/svg/avatars/003-girl-1.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @elseif($loker->kode_area == 'wb2')
                                                <img src="assets/media/svg/avatars/003-girl-1.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @elseif($loker->kode_area == 'ws1')
                                                <img src="assets/media/svg/avatars/023-girl-13.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @elseif($loker->kode_area == 'ws2')
                                                <img src="assets/media/svg/avatars/023-girl-13.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @elseif($loker->kode_area == 'pb1')
                                                <img src="assets/media/svg/avatars/009-boy-4.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @elseif($loker->kode_area == 'pb2')
                                                <img src="assets/media/svg/avatars/009-boy-4.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @elseif($loker->kode_area == 'ps1')
                                                <img src="assets/media/svg/avatars/008-boy-3.svg" alt=""
                                                    class="align-self-end h-100px" />
                                            @else
                                                <img src="assets/media/svg/avatars/008-boy-3.svg" alt=""
                                                    class="align-self-end h-100px" />
                        ...
                        <div class="modal fade" id="input_loker" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card card-custom">
                                                    <form action="{{ url('loker/post_user_loker') }}" method="post">
                                                        ...
                                                        <input type="hidden" name="no_loker"
                                                            class="input_value_no_loker" value="">
                                                        <input type="hidden" name="kode_area"
                                                            class="input_value_kode_area" value="">
                                                        <input type="hidden" name="kode_blok"
                                                            class="input_value_kode_blok" value="">
                                                                    ...
                                                                    <div class="form-group mb-8">
                                                                        <div class="alert alert-custom alert-default"
                                                                            ...
                                                                            <div class="alert-icon"><i
                                                                                    class="flaticon-warning text-primary"></i>
                                                                            </div>
                                                                            <div class="alert-text">
                                                                                FORM INPUT LOKER <a
                                                                                    href="javascript:void(0)"
                                                                                    class="ml-4 btn btn-dark TandaiRusak"
                                                                                    style="border-radius: 13px;"
                                                                                    onclick="tandai_rusak()"><i
                                                                                        class="fas fa-bookmark"></i> Tandai
                                                                                    Rusak</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="exampleSelect1">Pilih Karyawan <span
                                                                                class="text-danger">*</span></label>
                                                                        <select class="form-control select2 Karyawan"
                                                                            id="exampleSelect1" name="nik_karyawan_baru"
                                                                            style="width: 100%;">
                                                                            <option selected disabled>Silahkan Pilih
                                                                            </option>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary BtnSave"><i
                        ...
                        <div class="modal fade" id="modal_history_karyawan" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-toolbar">
                                                            <a href="javascript:void(0)" class="btn btn-sm"
                                                                onclick="BtnExport()"
                                                                style="background-color: rgb(143, 238, 0)"><i
                                                                    class="fas fa-file-excel text-dark"></i> Export To
                                                                Excel </a>
                                                        </div>
                                                    </div>
                                                    <div class="card-body">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary BtnCloseHistory"
                                                data-dismiss="modal">Close</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal fade" id="modal_loker_kosong" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
                                                            ...
                                                            <ul class="nav nav-tabs nav-bold nav-tabs-line">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link" data-toggle="tab"
                                                                        ...
                                                                        <span class="nav-text">List Loker Karyawan
                                                                            Aktif</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="tab-content">
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($pb1) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($pb1) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    @foreach ($pb1 as $list)
                                                                                                        <div
                                                                                                            class="col-sm-2">
                                                                                                            <div
                                                                                                                class="symbol symbol-80 symbol-light-info mr-4 flex-shrink-0 mt-4">
                                                                                                                <div
                                                                                                                    class="symbol-label">
                                                                                                                    <i
                                                                                                                        class="symbol-badge bg-success"></i>
                                                                                                                    <a
                                                                                                                        href="javascript:void(0)">
                                                                                                                        <span
                                                                                                                            class="svg-icon svg-icon-lg svg-icon-dark">
                                                                                                                        </span>
                                                                                                                        {{ $list['no_loker'] ?? '' }}
                                                                                                                    </a>
                                                                                                                </div>
                                                                                                                <center>
                                                                                                                    <span
                                                                                                                        class="badge badge-info bagde-pill mt-1">
                                                                                                                        Free
                                                                                                                    </span>
                                                                                                                </center>
                                                                                                            </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($pb2) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($pb2) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($ps1) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($ps1) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($ps2) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($ps2) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($wb1) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($wb1) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($wb2) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($wb2) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($ws1) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($ws1) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="card">
                                                                                        <div class="card-header"
                                                                                            ...
                                                                                            <div class="card-title"
                                                                                                ...
                                                                                                @if (count($ws2) > 0)
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-primary ml-4">{{ count($ws2) }}
                                                                                                        Loker Free</span>
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                            ...
                                                            <div class="tab-pane fade" id="kt_tab_pane_2_4"
                                                                role="tabpanel" aria-labelledby="kt_tab_pane_2_4">
                                                                <div class="row">
                                                                                    ...
                                                                                    @foreach ($master_user->where('nik', '!=', '') as $list)
                                                                                        <tr class="text-center">
                                                                                            ...
                                                                                            <td> <a href="javascript:void(0)"
                                                                                                    onclick="history_karyawan('{{ $list->nik }}')">
                                                                                                    {{ $list->nama }}
                                                                                                </a>
                                                                                            </td>
                                                                                            <td>{{ $list->nik }}</td>
                                                                                            ...
                                                                                            <td>
                                                                                                @if ($list->no_loker == '')
                                                                                                    <span
                                                                                                        class="badge badge-pill badge-dark">Kosong</span>
                                                                                                @else
                                                                                                    {{ $list->no_loker }}
                                                                                                @endif
                                                                                            </td>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <a href="javascript:void(0)" class="badge badge-primary mt-3"
                                                    style="width: 100%;"> Total Loker Kosong :
                                                    {{ count($cek_loker_kosong) }} Pintu</a>
                                                <a href="javascript:void(0)" class="badge badge-info mt-3"
                                                    style="width: 100%;"> Total Loker Terisi : {{ $cek_loker_terisi }}
                                                    Pintu</a>
                                                <a href="javascript:void(0)" class="badge badge-dark mt-3"
                                                    style="width: 100%;"> Total Loker Rusak : {{ $cek_loker_rusak }}
                                                    Pintu</a>

                                            </div>
                                            <div class="col-sm-8">
                                                <h2 class="mt-4">Total Loker :
                                                    {{ $cek_loker_terisi + count($cek_loker_kosong) + $cek_loker_rusak }}
                                                    PINTU</h2>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="detail_loker" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
                    aria-hidden="true">
                                                                ...
                                                                <div class="d-flex mb-9">
                                                                    <div class="flex-shrink-0 mr-7 mt-lg-0 mt-3">
                                                                        <div class="symbol symbol-50 symbol-lg-120">
                                                                            <img id="picture" class="mr-4"
                                                                                src="/assets/media/users/blank.png"
                                                                                style="width: 150%;border-radius: 10px; margin-right: 23px;"
                                                                                alt="image" />
                                                                        </div>
                                                                        <div
                                                                            class="symbol symbol-50 symbol-lg-120 symbol-primary d-none">
                                                                            <span
                                                                                class="font-size-h3 symbol-label font-weight-boldest"></span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-grow-1">
                                                                        <div
                                                                            class="d-flex justify-content-between flex-wrap mt-1">
                                                                            <div class="d-flex mr-3">
                                                                                <a href="#"
                                                                                    class="text-dark-75 text-hover-primary font-size-h5 font-weight-bold mr-3 Nama"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                class="d-flex flex-column flex-grow-1 pr-8">
                                                                                <div class="d-flex flex-wrap mb-4">
                                                                                    <a class="text-dark font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 "
                                                                                        style="margin-left: 20px;">
                                                                                        DEPT : <b class="DeptValue"></b>
                                                                                    </a>
                                                                                    <a class="text-dark font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 "
                                                                                        style="margin-left: 20px;">
                                                                                    ...
                                                                                    <a class="text-dark font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 "
                                                                                        style="margin-left: 20px;">
                                                                                        KODE BLOK : <b
                                                                                            class="KodeBlokValue"></b></a>
                                                                                    <a class="text-dark font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2 "
                                                                                        style="margin-left: 20px;">
                                                                                        NO.LOKER : <b
                                                                                            class="NoLokerValue"></b></a>
                                                                                </div>
                                                                                <span
                                                                                    class="font-weight-bold text-dark KodeKontrakValue"
                ...
                <div class="modal fade" id="tarik_kunci" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
                    aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div id="reader"
                                            style="width:500px; height:500px; border-radius:20px; display: none;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal_upload" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card card-custom gutter-b">
                                                <form action="{{ url('loker/import_loker_user') }}" method="post"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="float-right">
                                                                <button type="submit"
                                                                    class="btn btn-primary btn-sm BtnUploadFile"
                                                                    style="border-radius: 13px;"><i
                                                                        class="fas fa-save"></i> Simpan</button>
                                                                <button type="button"
                                                                    class="btn btn-outline-danger spinner spinner-darker-danger spinner-left mr-3 Proses"
    ...
    <div class="modal fade" id="sudah_benar" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <a id="" class="btn btn-success btn-md" href="javascript:void(0)"
                                onclick="sudah_benar()" role="button"><i class="fas fa-check mr-4"></i> Tandai Loker
                                Sudah Tidak Rusak</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="list_kabur" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-custom gutter-b">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="kabur" role="tabpanel"
                                            aria-labelledby="kabur">
                                            ...
                                        </div>
                                        <div class="tab-pane fade show" id="phk" role="tabpanel"
                                            aria-labelledby="phk">
                                            <button id="phk-submit-button" type="submit"
                                                class="btn btn-primary btn-sm mb-2" style="display: none"><span
                                                    id="phk-submit-button-text">Tarik Loker</span> (<span
                                                    id="phk-submit-count"></span>)</button>
                                            <table id="phk-table"
                                                class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                                <thead>
                                                    <tr class="text-left text-uppercase">
                                                        <th style="width: 40px"><input type="checkbox" id="phk-check-all"
                ...
                <div class="card-footer">
                    <div class="float-right">
                        <button type="button" data-dismiss="modal"class="btn btn-dark btn-sm"
                            style="border-radius: 13px;"><i class="fas fa-times"></i> Tutup</button>
                    </div>
                </div>
                </form>
            </div>
    ...
    <div class="modal fade hide-print" id="list_pkw" tabindex="-1" role="dialog" aria-labelledby="list_pkw"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="pkw-laki-laki" role="tabpanel"
                                    aria-labelledby="kabur">
                                    <button id="laki-laki-submit-button" type="submit"
                                        class="btn btn-success btn-sm mb-2" style="display: none"><span
                                            id="laki-laki-submit-button-text">Save</span> (<span
                                            id="laki-laki-submit-count"></span>)</button>
                                    <div class="row" id="laki-laki-store-error" style="display: none">
                                        <div class="col-12">
                                            <div class="alert alert-danger">
                                                <span id="laki-laki-store-error-message"></span> : <strong
                                                    id="laki-laki-store-error-content"></strong>.
                                            </div>
                                        </div>
                                    </div>
                                    <table id="pkw-laki-laki-table"
                                        class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                        <thead>
                                            <tr class="text-left text-uppercase">
                                                <th style="width: 40px"><input type="checkbox" id="laki-laki-check-all"
                                                        class="form-control" /></th>
                                                <th style="min-width: 100px">NIK</th>
                                                <th style="min-width: 100px">NAMA</th>
                                                <th style="min-width: 100px">KODE AREA</th>
                                ...
                                <div class="tab-pane fade show" id="pkw-perempuan" role="tabpanel"
                                    aria-labelledby="kabur">
                                    <button id="perempuan-submit-button" type="submit"
                                        class="btn btn-success btn-sm mb-2" style="display: none"><span
                                            id="perempuan-submit-button-text">Save</span> (<span
                                            id="perempuan-submit-count"></span>)</button>
                                    <div class="row" id="perempuan-store-error" style="display: none">
                                        <div class="col-12">
                                            <div class="alert alert-danger">
                                                <span id="perempuan-store-error-message"></span> : <strong
                                                    id="perempuan-store-error-content"></strong>.
                                            </div>
                                        </div>
                                    </div>
                                    <table id="pkw-perempuan-table"
                                        class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                                        <thead>
                                            <tr class="text-left text-uppercase">
                                                <th style="width: 40px"><input type="checkbox" id="perempuan-check-all"
                                                        class="form-control" /></th>
                                                <th style="min-width: 100px">NIK</th>
                                                <th style="min-width: 100px">NAMA</th>
                                                <th style="min-width: 100px">KODE AREA</th>
...
@push('scripts')
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.data.length == 0) {
                        $("#phk-table tbody").html(
                            "<tr><td colspan='6'><span class='text-center'>No data found..</span></td></tr>"
                            )
                    }
    ...
    <script type="text/javascript">
        ...
        function getPKW(prefix) {
            ...
            $("#pkw-" + prefix + "-table tbody").html(
                "<tr><td colspan='6'><span class='text-center'>Loading..</span></td></tr>")
    ...
    <script type="text/javascript">
        ...
        function upload_excel(kode_area) {
            ...
            $('.BodyUpload').append('<a href="/master_import/upload_loker_' + kode_area +
                '.xlsx" class="btn btn-sm text-white" style="background-color: green; border-radius: 15px;"><i class="fas fa-file-excel text-white"></i> Download Master Excel</a>'
                );
                    ...
                    if (response.status == 1) {
                        ...
                        jQuery.each(response.data, function(id, value) {
                            ...
                            if (value.status == 0) {
                                ...
                                textfull =
                                    '<span class="badge badge-pill badge-info text-center">Free</span>';
                            }
                            if (value.status == 2) {
                                bg_color = 'symbol-light-dark';
                                show_badge = 'bg-dark';
                                textfull =
                                    '<span class="badge badge-pill badge-dark text-center">Rusak</span>';
                            }
                            if (value.status == 1) {
                                bg_color = 'symbol-light-danger';
                                show_badge = 'bg-danger';
                                textfull =
                                    '<span class="badge badge-pill badge-danger text-center">Full</span>';
                            }
                    ...
                    if (response.status == 1) {
                        if (response.data.status.status == 1) {
                            ...
                            jQuery.ajax({
                                ...
                                dataType: "json",
                                success: function(response) {
                                    $('#picture').attr('src', 'data:image/jpg;base64,' + response
                                        .data.image);
        ...
        function tarik_kunci_manual() {
            ...
            if (keterangan == null || keterangan == "") {} else {
                $.ajax({
                    type: "GET",
                    url: '/loker/tarik_kunci_manual/' + no_loker + '/' + kode_blok + '/' + kode_area + '/' + nik +
                        '/' + keterangan,
                    data: {
                        no_loker: no_loker,
                        kode_area: kode_area,
        ...
        function tarik_kunci(nik_pengisi, no_loker, kode_blok, kode_area) {
            ...
            $('#reader').html5_qrcode(function(no_loker, nik, keterangan) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: '/loker/tarik_kunci/' + no_loker + '/' + nik + '/' + keterangan + '/' + kode_blok +
                            '/' + kode_area,
                        data: {
                            no_loker: no_loker,
                            nik: nik,
                    ...
                    if (response.status == 1) {
                        ...
                        jQuery.each(response.data, function(id, value) {
                            $('.Body_' + kode_area).append('<div class="symbol symbol-80 symbol-light-warning mr-4 flex-shrink-0 mt-4">\
                                    <div class="symbol-label">\
                                        <a href="javascript:void(0)" onclick="cari_no_loker(\'' + value.kode_blok +
                                '\',\'' + value.kode_area + '\')" >\
