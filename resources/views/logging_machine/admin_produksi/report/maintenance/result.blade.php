...
@section('title', 'REPORT DOWNTIME MAINTENANCE')
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                         <div class="card-tittle">
                              <form action=" {{ url('logging_machine/adm_prod/report_maintenance')}} " method="POST">
                                   @csrf
                                   <div class="row">
                                     <div class="col">
...
<script type="text/javascript">
    ...
    Highcharts.chart('grafik', {
            title: {
                text: 'Grafik Downtime Engineering {{ date('d-M-Y') }}'
            },
            xAxis: {
