...
@section('title', 'REPORT HARIAN PACKING ALL LIST ')
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="row">
                                <div class="col-sm-3" id="varian">
                                    <form action="{{url('/logging_machine/adm_prod/pencarian_all_list/varian')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label>Varian</label>
                                ...
                                <div class="col-sm-3" id="nama">
                                    <form action="{{url('/logging_machine/adm_prod/pencarian_all_list/nama')}}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label>Nama</label>
                                ...
                                <div class="col-sm-6" id="tgl">
                                    <form action="{{url('/logging_machine/adm_prod/pencarian_all_list/tgl')}}" method="post">
                                        @csrf
                                           <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
