        ...
        <div class="row">
          ...
          <ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
               ...
               <li class="nav-item mb-2" id="kt_demo_panel_toggle" data-toggle="tooltip" title="Check out more demos" data-placement="right">
                 <a class="btn btn-sm btn-icon btn-bg-light btn-icon-success btn-hover-success" href="logging_machine/adm_prod/report_downtime">
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                         ...
                         <div class="card-toolbar">
                              <form action="{{url('/logging_machine/adm_prod/export_excel_downtime')}}" method="POST">
                                   @csrf
                                   <input type="hidden" class="form-control" value="{{$tgl_mulai}}" name="tgl_mulai">
                                   <input type="hidden" class="form-control" value="{{$tgl_selesai}}"  name="tgl_selesai">
                            <button type="submit" class="btn btn-primary btn-sm" style="background-color: green;"><i class="fas fa-file-excel"></i> Export To Excel</button>
                              </form>
                         </div>
                         </div>
                    <div class="card-body">
