                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-tittle">
                            <form action="/logging_machine/adm_prod/report_mesin" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col">
...
<script src="{{ url('/') }}/assets/js/highcharts/highcharts.js"></script>
    ...
    <script type="text/javascript">
        ...
        //     },
        //     title: {
        //         text: 'GRAFIK DATA DOWNTIME MESIN'
        //     },
        //     subtitle: {
        //         text: 'Seassoning 2'
        //     },
        ...
        //         categories: {!! json_encode($nama_mesin) !!},
        //     },
        //     yAxis: {
        //         min: 0,
        ...
        //             '<td style="padding:0"><b>{values}:</b></td></tr>',
        //         footerFormat: '</table>',
        //         shared: true,
        //         useHTML: true
        //     },
        ...
        // });
         ...
         Highcharts.chart('grafik', {
            title: {
                text: 'Grafik Downtime Mesin {{\Carbon\carbon::parse(date('Y-m-d'))->format('d/m/Y') }}'
            },
            xAxis: {
                categories: {!! json_encode($nama_mesin) !!}
            },
