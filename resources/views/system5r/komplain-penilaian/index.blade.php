...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            <h3 class="mb-3">FU KOMPLAIN HASIL PENILAIAN 5R</h3>
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="width: 5%">
                            <a href="{{ route('5r-system.komplain-penilaian.view', ['id_jawaban_group' => encrypt($d->id_jawaban_group)]) }}" class="btn btn-sm btn-primary btn-icon waves-effect waves-light">
