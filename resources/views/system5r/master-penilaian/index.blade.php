        ...
        <div id="scheduleContent" style="display: none;">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <img id="scheduleImage" src="{{ asset('/assets/velzon/images/ilustrasi_kalender.png') }}"
                                alt="Schedule Image" style="width: 100%; max-width: 300px;" class="shake-image">
                        </div>
                        <div class="col-md-6">
                            ...
                            <form method="POST" id="formTambahTahun" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    <input required type="number" class="form-control" id="tahun" name="tahun"
                                        ...
                                        oninvalid="this.setCustomValidity('Tahun Periode Penilaian tidak boleh kosong')"
