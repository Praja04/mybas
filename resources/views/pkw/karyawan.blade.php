                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Data PKW
                                <span class="d-block text-muted pt-2 font-size-sm">Data Karyawan</span>
                            </h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Dropdown-->
                            <div class="dropdown dropdown-inline mr-2">
                                <button type="button" class="btn btn-outline-secondary font-weight-bolder dropdown-toggle"
                                ...
                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                    ...
                                    <ul class="navi flex-column navi-hover py-2">
                                        <li
                                            class="navi-header font-weight-bolder text-uppercase font-size-sm text-dark-50 pb-2">
                                            Choose an option:</li>
                                        <li class="navi-item">
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-3 my-2 my-md-0">
                                            <div class="d-flex align-items-center">
                                                <label class="mr-3 mb-0 d-none d-md-block"
                                                    style="white-space: nowrap;">Jenis Kelamin:</label>
                                        ...
                                        <div class="col-md-3 my-2 my-md-0">
                                            <div class="d-flex align-items-center">
                                                <label class="mr-3 mb-0 d-none d-md-block"
                                                    style="white-space: nowrap;">Tgl Masuk: </label>
                                                <input type="date" class="form-control"
                                                    id="datatable_search_tgl_masuk">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mt-10 mb-5 collapse" id="datatable_group_action_form">
                            <div class="d-flex align-items-center">
                                ...
                                <button class="ml-10 btn btn-sm btn-danger" type="button" id="sendToRecruitment"><i
                                        class="fa fa-reply"></i> Kembalikan Ke Recruitment</button>
                            </div>
                        </div>
                        <!--begin: Datatable-->
                        <div class="table-responsive">
                            <div class="table-bordered table-hover datatable datatable-bordered datatable-head-custom"
                                id="karyawan-datatable"></div>
                        </div>
                        <!--end: Datatable-->
                    </div>
                </div>
...
@push('scripts')
    <script type="text/javascript">
        ...
        function showFoto(jenis, foto) {
            var primaryUrl = "{{ url('images') }}/" + jenis + "/" + foto;
            var fallbackUrl = "http://172.21.5.105/images/" + jenis + "/" + foto;
            ...
            var options = {
                ...
                columns: [{
                        ...
                        template: function(row) {
                            var status_diri = row.foto_diri == '' ? 'btn-outline-danger' :
                                'btn-outline-success';
                            var status_ktp = row.foto_ktp == '' ? 'btn-outline-danger' :
                                'btn-outline-success';
                            var status_npwp = row.foto_npwp == '' ? 'btn-outline-danger' :
                                'btn-outline-success';
                            var status_kk = row.foto_kk == '' ? 'btn-outline-danger' :
                                'btn-outline-success';
                            return '\
                                    <a onClick="showFoto(\'foto\', \'' + row.foto_diri +
                                '\')" href="javascript:;" class="btn btn-xs ' + status_diri + ' py-0 px-1 pl-2" title="Foto Diri">\
                                        <i class="fa fa-user"></i>\
                                    </a>\
                                    <a onClick="showFoto(\'ktp\', \'' + row.foto_ktp +
                                '\')" href="javascript:;" class="btn btn-xs ' + status_ktp + ' py-0 px-1" title="Foto Ktp">\
                                        <span>ktp</span>\
                                    </a>\
                                    <a onClick="showFoto(\'npwp\', \'' + row.foto_npwp +
                                '\')" href="javascript:;" class="btn btn-xs ' + status_npwp + ' py-0 px-1" title="Foto NPWP">\
                                        <span>npwp</span>\
                                    </a>\
                                    <a onClick="showFoto(\'kk\', \'' + row.foto_kk +
                                '\')" href="javascript:;" class="btn btn-xs ' + status_kk + ' py-0 px-1" title="Foto KK">\
                                        <span>kk</span>\
                                    </a>\
                                ';
                        },
            ...
            var serverSelectorDemo = function() {
                ...
                $("#sendToRecruitment").on("click", function() {
                    ...
                    $.ajax({
                        ...
                        dataType: "JSON",
                        success: function(response) {
                            Swal.fire("Oke!", "Berhasil dikembalikan ke recruitment!",
                                    "success")
                                .then((value) => {
                                    $('#sendToRecruitment').removeAttr('disabled');
                                    $('#sendToRecruitment').text(
                                        'Kembalikan ke recruitment');
                                    datatable.reload();
                                });
                        },
                        error: function(e) {
