                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Data PKW
                                <span class="d-block text-muted pt-2 font-size-sm">Data Karyawan PKWT</span></h3>
                        </div>
                        <div class="card-toolbar">
                            <ul class="nav nav-pills nav-pills-sm nav-dark-75">
                                <li class="nav-item">
                                    <a class="nav-link py-2 px-4 active" href="{{ url('/pkw/pkwt') }}">PKWT</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link py-2 px-4" href="{{ url('/pkw/pkwtt') }}">PKWTT</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="table-bordered table-hover datatable datatable-bordered datatable-head-custom" id="pkwt-datatable"></div>
                        </div>
                        <!--end: Datatable-->
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        var KTDatatableRecordSelectionDemo = function() {
            ...
            var serverSelectorDemo = function() {
                ...
                var datatable = $('#pkwt-datatable').KTDatatable(options);
