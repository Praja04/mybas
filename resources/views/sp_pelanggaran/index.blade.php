                        ...
                        <form id="spForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 p-3 bg-light border rounded">
                                <label for="select_kode_pelanggaran" class="form-label fw-bold text-primary mb-1">
                                    <i class="ri-magic-line me-1"></i> Auto-Suggest Kode Admin Pelanggaran (Pilih untuk Auto-Fill)
                                </label>
                                <select id="select_kode_pelanggaran" class="form-select select2">
                                    <option value="">-- Ketik Nama/Kode Pelanggaran (misal: Teguran Lisan 2x, SOP, Terlambat 2x) --</option>
                                ...
                                <div class="form-text text-muted small">Memilih kode akan mengisi Kode Admin, Pasal, dan Detail Alasan secara otomatis.</div>
                                <input type="hidden" name="kode_admin" id="kode_admin" value="{{ isset($editSp) ? $editSp->kode_admin : '' }}">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="tanggal_pelanggaran">Tanggal Pelanggaran / Kejadian Utama <span class="text-danger">*</span></label>
                                     ...
                                     <div class="form-group mb-3 p-3 bg-light rounded border border-secondary border-opacity-25">
                                         <div class="d-flex align-items-center justify-content-between mb-2">
                                             <label class="form-label mb-0 fw-bold text-dark small">
                                                 <i class="ri-calendar-event-line me-1 text-primary"></i> Tanggal Kejadian Tambahan (Untuk Kasus Multi-Hari / Multi-Date)
                                             </label>
                                             <button type="button" class="btn btn-xs btn-outline-primary py-0 px-2" id="btnAddDateRow">
                                             ...
                                             @if(isset($editSp) && $editSp->dates->count() > 1)
                                                 @foreach($editSp->dates as $idx => $d)
                                                     ...
                                                     <div class="input-group input-group-sm mb-2 date-row-item">
                                                         ...
                                                         <input type="date" name="tanggal_terlambat_list[]" class="form-control" value="{{ $d->tanggal }}" required>
                                         ...
                                         <small class="text-muted d-block mt-1" style="font-size:0.75rem">
                                             Klik <strong>+ Tambah Tanggal</strong> jika kasus pelanggaran/terlambat/mangkir terjadi lebih dari 1 hari dalam 1 pengajuan SP.
                                         </small>
                                     </div>
