        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <img style="height: 35px" src="{{ asset('assets/media/logos/bas_text.png') }}" alt="Logo PT. PAS">
                </div>
            </div>
                        ...
                        <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                <img class="rounded-circle header-profile-user"
                                    src="{{ asset('assets/velzon/images/users/multi-user.jpg') }}" alt="Header Avatar">
                                <span class="text-start ms-xl-2">
                                    <span
                                        class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ auth()->user()->name }}</span>
                                    <span
                                        class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ auth()->user()->department->name }}</span>
                                </span>
                            </span>
                        </button>
