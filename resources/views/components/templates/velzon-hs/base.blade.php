...
<!DOCTYPE html>
<html lang="id" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="enable">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <x-templates.velzon-hs.sidebar activeMenu="{{ $activeMenu }}" nameIcon="{{ $nameIcon }}" shortName="{!! $shortName !!}" longName="{!! $longName !!}" menus="{!! $menus !!}" />
