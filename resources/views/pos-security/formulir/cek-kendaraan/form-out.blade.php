            ...
            <div class="card p-4 p-lg-5 shadow-sm form-container">
                ...
                <div id="tableWrapperOut">
                    ...
                    <div class="table-responsive">
                        <table class="table nowrap align-middle" id="tableOutCustom" style="width:100%">
                            <thead>
                                <tr>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 mt-3">
                        <div id="paginationInfoOut" class="text-muted small"></div>
                        <nav>
                            <ul class="pagination pagination-sm mb-0" id="paginationListOut">
                            </ul>
                        </nav>
                    </div>
                </div>
                ...
                <div id="formWrapperOut" style="display: none;">
                    ...
                    <form id="cekKendaraanFormOut" method="POST" enctype="multipart/form-data" onsubmit="return false;"
                        ...
                        {{-- Alert foto --}}
                        <div id="alertFotoWajibOut" class="alert alert-primary d-none">
                        ...
                        {{-- Foto Section --}}
                        <div class="row">
                            <div id="fotoSectionOut" class="row my-3"></div>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <video id="videoOut" autoplay width="100%" class="rounded shadow-sm mb-3"
