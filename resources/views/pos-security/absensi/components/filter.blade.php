            ...
            <div class="card-body">
                <form id="filter-form">
                    <div class="row g-3 align-items-end">
                        ...
                        <!-- Nama Visitor -->
                        <div class="col-xl-3 col-md-6">
                            <label class="form-label fw-semibold text-muted">Nama Pengunjung / Nama Perusaahan /
                                Tujuan</label>
                        ...
                        <!-- No. Kartu -->
                        <div class="col-xl-3 col-md-6">
                            <label class="form-label fw-semibold text-muted">No. Kartu / RFID / Nomor Identitas</label>
