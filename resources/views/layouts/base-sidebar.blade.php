...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ url('/') }}/assets/css/themes/layout/header/base/light.css?v=7.0.5" rel="stylesheet"
            type="text/css" />
        <link href="{{ url('/') }}/assets/css/themes/layout/brand/dark.css?v=7.0.5" rel="stylesheet"
            type="text/css" />
        <link href="{{ url('/') }}/assets/css/themes/layout/aside/dark.css?v=7.0.5" rel="stylesheet"
            type="text/css" />
                ...
                <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                    <div class="brand flex-column-auto" id="kt_brand">
                        @if (in_array('cycle_count', $permissions))
                            <img alt="Logo"
                                src="{{ url('/') }}/assets/media/cartoon/cycle-count/cycle-count.png"
                                style="width: 70%" />
                        @else
                            @yield('logo')
                        @endif
                        ...
                        <div id="kt_aside_menu" class="aside-menu mb-4" data-menu-vertical="1" data-menu-scroll="1"
                            ...
                            <ul class="menu-nav">
                                ...
                                @if (Request::is('edoc') or Request::is('edoc/*'))
                                    ...
                                    @endif
                                    <li class="menu-item {{ request()->is('edoc/history?filter=all') ? 'menu-item-active' : '' }}"
                                        aria-haspopup="true">
                                        <a class="menu-link" href="{{ url('edoc/history?filter=all') }}">
                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    <div id="kt_header" class="header header-fixed">
                        <div class="container-fluid d-flex align-items-stretch justify-content-between">
                            <div class="header-menu-wrapper header-menu-wrapper-left d-flex"
